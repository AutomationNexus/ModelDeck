...
# ---------------------------------------------------------------------------
# H. New account label bug — a brand-new wizard account (not yet on disk) must
# get the server-generated "{Provider Display Name} {n}" label, never the bare
# account_id, whether it goes through the OAuth path or the paste-credentials
# path. Re-pasting credentials on an EXISTING account must preserve its label.
# ---------------------------------------------------------------------------
